 ...
 */
public class ShareUrl extends AsyncTask<String,String,String> {
    int success=0;
    String url,userid;
    Post p;
    ...
    public ShareUrl(Context c, String url,String userid, ArticleReceivedListener arl)
    {
        this.url = url;
        this.userid = userid;
        this.listener = arl;
    ...
    protected String doInBackground(String... params) {
        ...
        lp.add(new BasicNameValuePair("url",url));
        lp.add(new BasicNameValuePair("userid",userid));
        String urlstring = "http://172.22.97.2:8080/NewsGroup/mShare";
        try {
